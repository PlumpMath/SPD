...
var url_encode__delegate = function (s,p__18471){var vec__18473 = p__18471;var encoding = cljs.core.nth.call(null,vec__18473,0,null);if(cljs.core.truth_(s))
...
var p__18471 = null;if (arguments.length > 1) {
  p__18471 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__18471);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__18474){
var s = cljs.core.first(arglist__18474);
var p__18471 = cljs.core.rest(arglist__18474);
return url_encode__delegate(s,p__18471);
});
...
var url_decode__delegate = function (s,p__18475){var vec__18477 = p__18475;var encoding = cljs.core.nth.call(null,vec__18477,0,null);if(cljs.core.truth_(s))
...
var p__18475 = null;if (arguments.length > 1) {
  p__18475 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__18475);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__18478){
var s = cljs.core.first(arglist__18478);
var p__18475 = cljs.core.rest(arglist__18478);
return url_decode__delegate(s,p__18475);
});
...
{var G__18481 = clojure.string.upper_case.call(null,unit);if(new cljs.core.Keyword(null,"else","else",1017020587))
{var G__18482 = unit;if(cljs.core._EQ_.call(null,"B",G__18482))
{return (number * 1000000000);
} else
{if(cljs.core._EQ_.call(null,"M",G__18482))
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__18483_SHARP_){return parseInt(p1__18483_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__18484_SHARP_){return parseInt(p1__18484_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__18485_SHARP_){return parseFloat(p1__18485_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__18486_SHARP_){return parseFloat(p1__18486_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__18489_SHARP_){return clojure.string.join.call(null,"=",p1__18489_SHARP_);
}),cljs.core.map.call(null,(function (p1__18488_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__18488_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__18488_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__18487_SHARP_){return clojure.string.blank_QMARK_.call(null,[cljs.core.str(cljs.core.second.call(null,p1__18487_SHARP_))].join(''));
...
*/
no.en.core.format_url = (function format_url(m){return [cljs.core.str(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",4400883991).cljs$core$IFn$_invoke$arity$1(m))),cljs.core.str("://"),cljs.core.str((function (){var map__18491 = m;var map__18491__$1 = ((cljs.core.seq_QMARK_.call(null,map__18491))?cljs.core.apply.call(null,cljs.core.hash_map,map__18491):map__18491);var password = cljs.core.get.call(null,map__18491__$1,new cljs.core.Keyword(null,"password","password",2230889997));var user = cljs.core.get.call(null,map__18491__$1,new cljs.core.Keyword(null,"user","user",1017503549));if(cljs.core.truth_(user))
...
})()),cljs.core.str(new cljs.core.Keyword(null,"uri","uri",1014020318).cljs$core$IFn$_invoke$arity$1(m)),cljs.core.str((function (){var temp__4124__auto__ = new cljs.core.Keyword(null,"query-params","query-params",1080249757).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4124__auto__))
{var query_params = temp__4124__auto__;return [cljs.core.str("?"),cljs.core.str(no.en.core.format_query_params.call(null,query_params))].join('');
} else
{return null;
}
})())].join('');
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__18494_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__18494_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__18494_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__18493_SHARP_){return cljs.core._EQ_.call(null,2,cljs.core.count.call(null,p1__18493_SHARP_));
}),cljs.core.map.call(null,(function (p1__18492_SHARP_){return clojure.string.split.call(null,p1__18492_SHARP_,/=/);
