...
{{
var G__11675 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11675;
continue;
}
} else
...
{var pred__11679 = cljs.core._EQ_;var expr__11680 = limit;if(cljs.core.truth_(pred__11679.call(null,1,expr__11680)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11679.call(null,2,expr__11680)))
...
var G__11682 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11683 = (limit__$1 - 1);
var G__11684 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11682;
limit__$1 = G__11683;
parts = G__11684;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___11686 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___11686))
{var replacement_11687 = temp__4124__auto___11686;buffer.append([cljs.core.str(replacement_11687)].join(''));
} else
{buffer.append(ch);
}
{
var G__11688 = (index + 1);
index = G__11688;
continue;
}
}
