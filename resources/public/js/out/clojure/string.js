...
{{
var G__16202 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16202;
continue;
}
} else
...
{var pred__16206 = cljs.core._EQ_;var expr__16207 = limit;if(cljs.core.truth_(pred__16206.call(null,1,expr__16207)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16206.call(null,2,expr__16207)))
...
var G__16209 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16210 = (limit__$1 - 1);
var G__16211 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16209;
limit__$1 = G__16210;
parts = G__16211;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___16213 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16213))
{var replacement_16214 = temp__4124__auto___16213;buffer.append([cljs.core.str(replacement_16214)].join(''));
} else
{buffer.append(ch);
}
{
var G__16215 = (index + 1);
index = G__16215;
continue;
}
}
