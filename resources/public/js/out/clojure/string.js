...
{{
var G__10636 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10636;
continue;
}
} else
...
{var pred__10640 = cljs.core._EQ_;var expr__10641 = limit;if(cljs.core.truth_(pred__10640.call(null,1,expr__10641)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10640.call(null,2,expr__10641)))
...
var G__10643 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10644 = (limit__$1 - 1);
var G__10645 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10643;
limit__$1 = G__10644;
parts = G__10645;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10647 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10647))
{var replacement_10648 = temp__4090__auto___10647;buffer.append([cljs.core.str(replacement_10648)].join(''));
} else
{buffer.append(ch);
}
{
var G__10649 = (index + 1);
index = G__10649;
continue;
}
}
