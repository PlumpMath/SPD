...
sablono.util.ToString = (function (){var obj14575 = {};return obj14575;
})();
...
sablono.util.ToURI = (function (){var obj14577 = {};return obj14577;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__14578){
var xs = cljs.core.seq(arglist__14578);
...
{var vec__14580 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__14580,0,null);var words = cljs.core.nthnext.call(null,vec__14580,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__14581_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__14581_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__14581_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__14581_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__14582){
var maps = cljs.core.seq(arglist__14582);
...
*/
sablono.util.normalize_element = (function normalize_element(p__14587){var vec__14590 = p__14587;var tag = cljs.core.nth.call(null,vec__14590,0,null);var content = cljs.core.nthnext.call(null,vec__14590,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__14591 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__14591,0,null);var id = cljs.core.nth.call(null,vec__14591,1,null);var class$ = cljs.core.nth.call(null,vec__14591,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
