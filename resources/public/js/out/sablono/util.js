...
sablono.util.ToString = (function (){var obj16328 = {};return obj16328;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7868__auto__ = x;if(and__7868__auto__)
...
{var x__8507__auto__ = (((x == null))?null:x);return (function (){var or__7880__auto__ = (sablono.util.to_str[goog.typeOf(x__8507__auto__)]);if(or__7880__auto__)
{return or__7880__auto__;
} else
{var or__7880__auto____$1 = (sablono.util.to_str["_"]);if(or__7880__auto____$1)
...
sablono.util.ToURI = (function (){var obj16330 = {};return obj16330;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7868__auto__ = x;if(and__7868__auto__)
...
{var x__8507__auto__ = (((x == null))?null:x);return (function (){var or__7880__auto__ = (sablono.util.to_uri[goog.typeOf(x__8507__auto__)]);if(or__7880__auto__)
{return or__7880__auto__;
} else
{var or__7880__auto____$1 = (sablono.util.to_uri["_"]);if(or__7880__auto____$1)
{return or__7880__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__16331){
var xs = cljs.core.seq(arglist__16331);
...
{var vec__16333 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__16333,0,null);var words = cljs.core.nthnext.call(null,vec__16333,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__16334_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__16334_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16334_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__16334_SHARP_))
{return p1__16334_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__16335){
var maps = cljs.core.seq(arglist__16335);
...
*/
sablono.util.normalize_element = (function normalize_element(p__16340){var vec__16343 = p__16340;var tag = cljs.core.nth.call(null,vec__16343,0,null);var content = cljs.core.nthnext.call(null,vec__16343,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7880__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7880__auto__))
{return or__7880__auto__;
} else
