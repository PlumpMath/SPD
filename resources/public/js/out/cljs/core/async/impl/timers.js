...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13675 = 0;while(true){
if((i_13675 < arr.length))
{(arr[i_13675] = null);
{
var G__13676 = (i_13675 + 1);
i_13675 = G__13676;
continue;
}
} else
...
{var i_13682 = (self__.level + 1);while(true){
if((i_13682 <= (new_level + 1)))
{(update[i_13682] = self__.header);
{
var G__13683 = (i_13682 + 1);
i_13682 = G__13683;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13684 = 0;while(true){
if((i_13684 <= self__.level))
{var links_13685 = (update[i_13684]).forward;if(((links_13685[i_13684]) === x__$1))
{(links_13685[i_13684] = (x__$1.forward[i_13684]));
{
var G__13686 = (i_13684 + 1);
i_13684 = G__13686;
continue;
}
} else
{{
var G__13687 = (i_13684 + 1);
i_13684 = G__13687;
continue;
}
}
