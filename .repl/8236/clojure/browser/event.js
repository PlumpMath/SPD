...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj30992 = {};return obj30992;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7880__auto__ = this$;if(and__7880__auto__)
...
{var x__8519__auto__ = (((this$ == null))?null:this$);return (function (){var or__7892__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8519__auto__)]);if(or__7892__auto__)
{return or__7892__auto__;
} else
{var or__7892__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7892__auto____$1)
...
return (function (p__30993){var vec__30994 = p__30993;var k = cljs.core.nth.call(null,vec__30994,0,null);var v = cljs.core.nth.call(null,vec__30994,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__30995){var vec__30996 = p__30995;var k = cljs.core.nth.call(null,vec__30996,0,null);var v = cljs.core.nth.call(null,vec__30996,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
