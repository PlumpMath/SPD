...
{{
var G__25896 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25896;
continue;
}
} else
...
{var pred__25900 = cljs.core._EQ_;var expr__25901 = limit;if(cljs.core.truth_(pred__25900.call(null,1,expr__25901)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25900.call(null,2,expr__25901)))
...
var G__25903 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25904 = (limit__$1 - 1);
var G__25905 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25903;
limit__$1 = G__25904;
parts = G__25905;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___25907 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___25907))
{var replacement_25908 = temp__4124__auto___25907;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_25908)));
} else
{buffer.append(ch);
}
{
var G__25909 = (index + 1);
index = G__25909;
continue;
}
}
