...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj19924 = {};return obj19924;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__8650__auto__ = this$;if(and__8650__auto__)
...
{var x__9289__auto__ = (((this$ == null))?null:this$);return (function (){var or__8662__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__9289__auto__)]);if(or__8662__auto__)
{return or__8662__auto__;
} else
{var or__8662__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__8662__auto____$1)
...
return (function (p__19925){var vec__19926 = p__19925;var k = cljs.core.nth.call(null,vec__19926,0,null);var v = cljs.core.nth.call(null,vec__19926,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__19927){var vec__19928 = p__19927;var k = cljs.core.nth.call(null,vec__19928,0,null);var v = cljs.core.nth.call(null,vec__19928,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
