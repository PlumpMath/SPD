...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_25775 = 0;while(true){
var m_25776 = cljs.core.async.impl.dispatch.tasks.pop();if((m_25776 == null))
{} else
{m_25776.call(null);
if((count_25775 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__25777 = (count_25775 + 1);
count_25775 = G__25777;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8650__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8650__auto__)
