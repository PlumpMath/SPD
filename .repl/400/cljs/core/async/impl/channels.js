...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t25781 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t25781 = (function (val,box,meta25782){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t25781.cljs$lang$type = true;
cljs.core.async.impl.channels.t25781.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t25781";
cljs.core.async.impl.channels.t25781.cljs$lang$ctorPrWriter = (function (this__9229__auto__,writer__9230__auto__,opt__9231__auto__){return cljs.core._write.call(null,writer__9230__auto__,"cljs.core.async.impl.channels/t25781");
});
cljs.core.async.impl.channels.t25781.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t25781.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25783){var self__ = this;
var _25783__$1 = this;return self__.meta25782;
});
cljs.core.async.impl.channels.t25781.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25783,meta25782__$1){var self__ = this;
var _25783__$1 = this;return (new cljs.core.async.impl.channels.t25781(self__.val,self__.box,meta25782__$1));
});
cljs.core.async.impl.channels.__GT_t25781 = (function __GT_t25781(val__$1,box__$1,meta25782){return (new cljs.core.async.impl.channels.t25781(val__$1,box__$1,meta25782));
});
}
return (new cljs.core.async.impl.channels.t25781(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9232__auto__,writer__9233__auto__,opts__9234__auto__){return cljs.core._write.call(null,writer__9233__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9229__auto__,writer__9230__auto__,opt__9231__auto__){return cljs.core._write.call(null,writer__9230__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_25784 = self__.takes.pop();if((taker_25784 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_25784))
{var take_cb_25785 = cljs.core.async.impl.protocols.commit.call(null,taker_25784);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_25785,taker_25784,this$__$1){
return (function (){return take_cb_25785.call(null,null);
});})(take_cb_25785,taker_25784,this$__$1))
);
} else
{}
{
