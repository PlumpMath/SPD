...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj11107 = {};return obj11107;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__8648__auto__ = this$;if(and__8648__auto__)
...
{var x__9287__auto__ = (((this$ == null))?null:this$);return (function (){var or__8660__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__9287__auto__)]);if(or__8660__auto__)
{return or__8660__auto__;
} else
{var or__8660__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__8660__auto____$1)
...
return (function (p__11108){var vec__11109 = p__11108;var k = cljs.core.nth.call(null,vec__11109,0,null);var v = cljs.core.nth.call(null,vec__11109,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__11110){var vec__11111 = p__11110;var k = cljs.core.nth.call(null,vec__11111,0,null);var v = cljs.core.nth.call(null,vec__11111,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
