...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9223__auto__,writer__9224__auto__,opt__9225__auto__){return cljs.core._write.call(null,writer__9224__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_21638 = 0;while(true){
if((i_21638 < arr.length))
{(arr[i_21638] = null);
{
var G__21639 = (i_21638 + 1);
i_21638 = G__21639;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9223__auto__,writer__9224__auto__,opt__9225__auto__){return cljs.core._write.call(null,writer__9224__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_21645 = (self__.level + 1);while(true){
if((i_21645 <= (new_level + 1)))
{(update[i_21645] = self__.header);
{
var G__21646 = (i_21645 + 1);
i_21645 = G__21646;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21647 = 0;while(true){
if((i_21647 <= self__.level))
{var links_21648 = (update[i_21647]).forward;if(((links_21648[i_21647]) === x__$1))
{(links_21648[i_21647] = (x__$1.forward[i_21647]));
{
var G__21649 = (i_21647 + 1);
i_21647 = G__21649;
continue;
}
} else
{{
var G__21650 = (i_21647 + 1);
i_21647 = G__21650;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__8656__auto__ = (cljs.core.truth_((function (){var and__8644__auto__ = me;if(cljs.core.truth_(and__8644__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__8644__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__8656__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__8656__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__8656__auto__,timeout__$1,me))
,msecs);
