...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t21737 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t21737 = (function (val,box,meta21738){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t21737.cljs$lang$type = true;
cljs.core.async.impl.channels.t21737.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t21737";
cljs.core.async.impl.channels.t21737.cljs$lang$ctorPrWriter = (function (this__9223__auto__,writer__9224__auto__,opt__9225__auto__){return cljs.core._write.call(null,writer__9224__auto__,"cljs.core.async.impl.channels/t21737");
});
cljs.core.async.impl.channels.t21737.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t21737.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21739){var self__ = this;
var _21739__$1 = this;return self__.meta21738;
});
cljs.core.async.impl.channels.t21737.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21739,meta21738__$1){var self__ = this;
var _21739__$1 = this;return (new cljs.core.async.impl.channels.t21737(self__.val,self__.box,meta21738__$1));
});
cljs.core.async.impl.channels.__GT_t21737 = (function __GT_t21737(val__$1,box__$1,meta21738){return (new cljs.core.async.impl.channels.t21737(val__$1,box__$1,meta21738));
});
}
return (new cljs.core.async.impl.channels.t21737(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9226__auto__,writer__9227__auto__,opts__9228__auto__){return cljs.core._write.call(null,writer__9227__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9223__auto__,writer__9224__auto__,opt__9225__auto__){return cljs.core._write.call(null,writer__9224__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_21740 = self__.takes.pop();if((taker_21740 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_21740))
{var take_cb_21741 = cljs.core.async.impl.protocols.commit.call(null,taker_21740);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_21741,taker_21740,this$__$1){
return (function (){return take_cb_21741.call(null,null);
});})(take_cb_21741,taker_21740,this$__$1))
);
} else
{}
{
