...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_21731 = 0;while(true){
var m_21732 = cljs.core.async.impl.dispatch.tasks.pop();if((m_21732 == null))
{} else
{m_21732.call(null);
if((count_21731 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__21733 = (count_21731 + 1);
count_21731 = G__21733;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8644__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8644__auto__)
