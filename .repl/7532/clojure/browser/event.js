...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj12636 = {};return obj12636;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__8644__auto__ = this$;if(and__8644__auto__)
...
{var x__9283__auto__ = (((this$ == null))?null:this$);return (function (){var or__8656__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__9283__auto__)]);if(or__8656__auto__)
{return or__8656__auto__;
} else
{var or__8656__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__8656__auto____$1)
...
return (function (p__12637){var vec__12638 = p__12637;var k = cljs.core.nth.call(null,vec__12638,0,null);var v = cljs.core.nth.call(null,vec__12638,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__12639){var vec__12640 = p__12639;var k = cljs.core.nth.call(null,vec__12640,0,null);var v = cljs.core.nth.call(null,vec__12640,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
